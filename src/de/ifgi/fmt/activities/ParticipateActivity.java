...
public class ParticipateActivity extends SherlockActivity {
	...
	class DownloadTask extends AsyncTask<String, Void, ArrayList<String>> {
		...
		protected void onPostExecute(ArrayList<String> results) {
			...
			if (results != null) {
				...
				// Set the TextViews with the attributes of the role the spinner
				// is set on
				...
				roleSpinner
						.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
							public void onItemSelected(AdapterView<?> parent,
								...
								// Set the TextViews with the selected role's
								// attributes
	...
	class UploadTask extends AsyncTask<String, Void, Void> {
		...
		protected Void doInBackground(String... url) {
			 ...
			 * 
			 * PROBLEM: Ich wei§ nicht wie ich aus dem String aus den
			 * SharedPrefs einen Cookie machen kann. Au§erdem hab ich noch
			 * keinen Plan, was ich anschlie§end mit dem CookieStore machen
			 * muss. Kenne mich da leider Ÿberhaupt nicht aus.
			 */
			...
			try {
				...
				Log.d("participation3", response.getEntity().getContent()
						.toString());
