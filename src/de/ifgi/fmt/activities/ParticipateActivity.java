...
public class ParticipateActivity extends SherlockActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		for (int i = 0; i < 3; i++) {
			roleTitle = new TextView(this);
			roleTitle.setTypeface(Typeface.DEFAULT_BOLD);
			roleTitle.setTextSize(16);
			roleTitle.setText("Title");
			roleDescription = new TextView(this);
			roleDescription.setPadding(0, 0, 0, 16);
			roleDescription
					.setText("Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. ");
