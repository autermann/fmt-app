...
public class MapActivity extends SherlockMapActivity
{
	...
	private class SitesOverlay extends ItemizedOverlay<OverlayItem>
	{
		...
		public SitesOverlay(Drawable marker)
		{
			...
			items.add(new OverlayItem(getPoint(51.940932, 7.609992), "Freeze Flashmob",
					" Come here on 23.05.2012"));
			items.add(new OverlayItem(getPoint(51.951195, 7.603297), "Freeze Flashmob",
					"Starting on 24.05.2012"));
			items.add(new OverlayItem(getPoint(51.962409, 7.631621), "Pillow Flashmob",
					"Party @ 25.05.2012"));
			items.add(new OverlayItem(getPoint(51.963995, 7.610507), "Pillow Flashmob",
					"Let's meet: 26.05.2012"));
